...
def extract_article_links(html_content: str) -> List[str]:
    ...
    # Strategy: Find all internal links within the domain.
    for link_tag in soup.find_all("a", href=True):
        article_link = link_tag["href"]
        # Simple filter for common internal article patterns (athe selector is subject to change)
...
def sanitize(raw_text: str) -> str:
    ...
    # This replaces "Article  Title -- The" with "Article Title The"
