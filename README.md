...
* `OUTPUT_DIR_PATH`: Replace `***INSERT FILEPATH HERE***`. If you do not configure this setting, the articles will be saved to a folder named "NPR" in the same directory as the utility.
